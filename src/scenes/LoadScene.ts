...
export class LoadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("tiles", "assets/levels/tilesTop.png", {
      frameWidth: 128,
      frameHeight: 128,
    });
    ...
    this.load.atlas(
      "sebastian",
      "assets/images/sebastian/spriteSheet.png",
      "assets/images/sebastian/spriteSheet.json",
    );
    this.load.atlas(
      "butcher",
      "assets/images/enemy/spriteSheet.png",
      "assets/images/enemy/spriteSheet.json",
    );
  }
  create() {
